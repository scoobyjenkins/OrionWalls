...
package com.oriondroids.orionwalls;
...
public class OrionWallpaper extends Activity {

    private static final String SETTINGS = "com.oriondroids.wallpaper_prefs";
    ...
    private void saveWallpaper(int position) throws IOException {
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + "/OrionDroids/wallpapers");
